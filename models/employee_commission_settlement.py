...
class EmployeeCommissionSettlement(db.Model):
    ...
    payment_id = db.Column(db.Integer, db.ForeignKey("employee_payment.id"), nullable=True)
    ...
    payment = db.relationship("EmployeePayment", foreign_keys=[payment_id], lazy=True)
